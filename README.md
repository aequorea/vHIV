...
<p>
Based on the behavior of HIV, the idea is to use glycans to provide the "broad strokes" for focusing on the region of interest, and use variation of the protein surface in the immediate vicinity of the region to more sharply focus the antibodies. It's like epitope focusing in the context of an evolutionary immune response.
</p>
<p>
